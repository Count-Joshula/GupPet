...
local Spells = { -- do not auto summon companion if any this buffs active
	[C_Spell.GetSpellInfo(5384)] = true, -- 	FeignDeath
	[C_Spell.GetSpellInfo(199483)] = true, -- 	Camouflage
	[C_Spell.GetSpellInfo(66)] = true, -- 	Invisibility
	[C_Spell.GetSpellInfo(27827)] = true, -- 	SpiritOfRedemption
	[C_Spell.GetSpellInfo(64355)] = true, -- 	Food1
	[C_Spell.GetSpellInfo(191876)] = true, -- 	Food2
	[C_Spell.GetSpellInfo(167152)] = true, -- 	Food3
	[C_Spell.GetSpellInfo(57073)] = true, -- 	Drink
	[C_Spell.GetSpellInfo(192002)] = true, -- 	FoodDrink
}
